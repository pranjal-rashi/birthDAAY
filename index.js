...
const config = {
  ...
  name: 'Rashi',
  text: 'May God Always Bless You',
  text1:'Khub Jada Tarakki Kar',
  text2:' Taki Mujhe Mehnat Na Karni Padhe'
};
...
x = setInterval(function() {
  ...
  let w = (c.width = window.innerWidth),
    ...
    hh = h / 2,
    opts = {
      strings: ['HAPPY', 'BIRTHDAY!', config.name, config.text,config.text1, config.text2],
      charSize: 30,
      charSpacing: 35,
      lineHeight: 40,
